      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 mt-4 space-y-6 relative z-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="relative inline-flex items-center justify-center px-6 py-2.5 overflow-hidden tracking-tighter text-white bg-slate-900 rounded-xl group shadow-lg cursor-pointer transition-transform active:scale-95 border border-white/20"
          >
            <span
              className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#0E52FF] rounded-full group-hover:w-64 group-hover:h-64"
            ></span>
            ...
            ></span>
            <span className="relative text-xs font-mono font-bold uppercase tracking-wider flex items-center space-x-2">
          ...
          <div className="bg-white/95 backdrop-blur-xl p-6 rounded-2xl max-w-xl w-full max-h-[85vh] overflow-y-auto border border-white shadow-2xl text-[#111111] space-y-4 my-auto relative">
            ...
            <form onSubmit={handleCreatePaper} className="space-y-4 font-sans">
              ...
              <div className="flex justify-end space-x-3 pt-3 border-t border-slate-200">
                ...
                <button
                  type="submit"
                  className="relative inline-flex items-center justify-center px-7 py-2.5 overflow-hidden tracking-tighter text-white bg-slate-900 rounded-xl group shadow-lg cursor-pointer transition-transform active:scale-95 border border-slate-800"
                >
                  <span
                    className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#0E52FF] rounded-full group-hover:w-64 group-hover:h-64"
                  ></span>
